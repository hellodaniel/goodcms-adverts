...
if (@$this->data['AdType']['mobile_width']) {
   $samples['Mobile'] = [$this->data['AdType']['mobile_width'], $this->data['AdType']['mobile_height']];
   $samples['Mobile@2x'] = [$this->data['AdType']['mobile_width'] * 2, $this->data['AdType']['mobile_height'] * 2];
}
